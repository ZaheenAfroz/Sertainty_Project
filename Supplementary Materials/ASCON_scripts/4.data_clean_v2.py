...
decrypted_path = r'C:/Users/zahee/OneDrive - Texas State University/Documents/Sertainty project/code_2025/scripts/ascon_decrypted_output.csv'
...
# === Align other logs to the trimmed NS log ===
ascon_trimmed = ascon_log.iloc[:len(ns_trimmed)].reset_index(drop=True)
