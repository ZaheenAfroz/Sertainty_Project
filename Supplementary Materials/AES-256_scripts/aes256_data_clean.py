...
aes_log_path = r'C:/Users/zahee/OneDrive - Texas State University/Documents/Sertainty project/code_2025/scripts/aes256_transmission_log.csv'
...
decrypted_path = r'C:/Users/zahee/OneDrive - Texas State University/Documents/Sertainty project/code_2025/scripts/aes256_decrypted_output.csv'
output_path = r'C:/Users/zahee/OneDrive - Texas State University/Documents/Sertainty project/code_2025/scripts/processed_log_aes256.csv'

# === Load logs ===
aes_log = pd.read_csv(aes_log_path)
...
aes_trimmed = aes_log.iloc[:len(ns_trimmed)].reset_index(drop=True)
...
ns_trimmed['send_time'] = aes_trimmed['Send_Started'].values
ns_trimmed['encryption_time'] = aes_trimmed['Encryption_Time_ms'].values
