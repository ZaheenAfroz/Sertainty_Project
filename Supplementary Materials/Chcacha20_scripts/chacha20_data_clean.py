...
chacha_log_path = r'C:/Users/zahee/OneDrive - Texas State University/Documents/Sertainty project/code_2025/scripts/chacha20_transmission_log.csv'
...
decrypted_path = r'C:/Users/zahee/OneDrive - Texas State University/Documents/Sertainty project/code_2025/scripts/chacha20_decrypted_output.csv'
output_path = r'C:/Users/zahee/OneDrive - Texas State University/Documents/Sertainty project/code_2025/scripts/processed_log_chacha20.csv'

# === Load logs ===
chacha_log = pd.read_csv(chacha_log_path)
...
chacha_trimmed = chacha_log.iloc[:len(ns_trimmed)].reset_index(drop=True)
...
ns_trimmed['send_time'] = chacha_trimmed['Send_Started'].values
ns_trimmed['encryption_time'] = chacha_trimmed['Encryption_Time_ms'].values
